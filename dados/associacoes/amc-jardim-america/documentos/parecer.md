# Parecer institucional — Associação dos Moradores e Comerciantes do Jardim América — A.M.C. Jardim América
...
**Utilidade pública:** estadual: Lei Estadual nº 22.137/2023 (Goiás) declarada no documento; verificação automática na Casa Civil de Goiás a cada saída (ver dossiê) — verificação: não verificável automaticamente (URLError) — conferir manualmente · federal:  não possui (declarado) · municipal:  'em processo de retirada' — expressão ambígua no documento; esclarecer com a Prefeitura de Goiânia

## Afinidades e enquadramento

**Áreas de atuação (afinidades para editais):** assistencia_social, defesa_direitos, cultura, esporte, educacao, saude, crianca_adolescente, pessoa_idosa, meio_ambiente, cidadania, desenvolvimento_local, voluntariado, comunicacao_comunitaria

**Atuação geográfica:** GO, GO/Goiânia, GO/Goiânia/Jardim América, GO/Goiânia/Nova Suíça, GO/Goiânia/Conjunto Oasis

**CNAEs:** 94.30-8-00, 94.93-6-00, 94.99-5-00 · **certificações:** nenhuma comprovada · a confirmar: utilidade_publica_estadual_go_lei_22137_2023

**Experiências:** mobilizacao_comunitaria, defesa_coletiva_direitos, mapeamento_territorial, comunicacao_comunitaria, eventos_culturais, articulacao_poder_publico

## Checklist de documentos — pronto para qualquer projeto

- [ ] Certidão Negativa de Débitos Federais (RFB/PGFN) — faltante — emitir: https://solucoes.receita.fazenda.gov.br/Servicos/certidaointernet/PJ/Emitir?Ni=02167849000180
- [ ] CNDT — Certidão Negativa de Débitos Trabalhistas — faltante — emitir: https://cndt-certidao.tst.jus.br/inicio.faces
...
_Gerado em 2026-09-13T06:09 — dados autodeclarados não recebem pontuação documental até a evidência ser anexada._
