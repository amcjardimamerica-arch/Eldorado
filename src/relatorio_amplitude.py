...
ETAPAS = [
    ...
    ("programas", "Identificação de programa, lei e modalidade", "Eldorado"),
    ...
    ("resultados", "Busca ativa de resultados, prorrogações e recursos", "Eldorado"),
    ("dashboard_dados", "Dados do dashboard (Eldorado/Farol)", "Eldorado"),
    ("relatorio_busca", "Relatório HTML datado (opcional, desligado)", "Eldorado"),
    ("parlamentares", "Carga de parlamentares para a área de emendas", "Eldorado"),
